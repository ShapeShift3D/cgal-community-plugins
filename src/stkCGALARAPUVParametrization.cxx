  ...
  vtkInformationVector** vtkNotUsed(inputVector), vtkInformationVector* outputVector)
{
  ...
  SMP::Error_code err = SMP::parameterize(surfaceMesh,
    SMP::ARAP_parameterizer_3<Surface_Mesh, Border_Parameterizer>(Border_Parameterizer(),
      CGAL::Eigen_solver_traits<Eigen::SparseLU<CGAL::Eigen_sparse_matrix<double>::EigenType> >(),
      this->Lambda, this->MaximumNumberOfIterations, this->Tolerance, this->SkipPostprocess),
    bhd, uv_map);
