...
//----------
// Declare the plugin
vtkStandardNewMacro(stkCGALBoolean);
...
//---------------------------------------------------
vtkPolyData* stkCGALBoolean::GetInputMeshA()
{
...
//----------------------------------------------------
vtkPolyData* stkCGALBoolean::GetInputMeshB()
{
...
//----------------------------------------------------
int stkCGALBoolean::FillOutputPortInformation(int,
	vtkInformation* info)
{
...
//----------------------------------------------------
void stkCGALBoolean::SetModeToUnion()
{
	this->SetMode(Modes::UNION);
}

//----------------------------------------------------
void stkCGALBoolean::SetModeToIntersection()
{
	this->SetMode(Modes::INTERSECTION);
}

//----------------------------------------------------
void stkCGALBoolean::SetModeToDifference()
{
	this->SetMode(Modes::TM1_MINUS_TM2);
}

//----------------------------------------------------
void stkCGALBoolean::SetModeToDifference2()
{
...
int stkCGALBoolean::RequestData(vtkInformation *,
                                ...
                                vtkInformationVector *outputVector)
{
	...
	stkCGALUtilities::vtkPolyDataToPolygonMesh(inputMeshA, input1);
	stkCGALUtilities::vtkPolyDataToPolygonMesh(inputMeshB, input2);
	...
	stkCGALUtilities::PolygonMeshToVtkUnstructuredGrid(boolean_op, output);
	output->Squeeze();
...
//---------------------------------------------------------------------------------------
Surface_Mesh* stkCGALBoolean::RunBooleanOperations(
	Surface_Mesh& tm1,
	Surface_Mesh& tm2,
	...
	int Mode)
{
	...
	if (Mode == stkCGALBoolean::Modes::UNION) {
