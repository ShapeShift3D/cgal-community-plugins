...
// -----------------------------------------------------------------------------
stkCGALLSCMUVParametrization::stkCGALLSCMUVParametrization()
{
	this->Lambda = 1000;
...
bool stkCGALLSCMUVParametrization::UpdatePointCoordinates(SurfaceMesh& sm, VertexUVMap& uv_map, vtkPolyData* polyData)
{
