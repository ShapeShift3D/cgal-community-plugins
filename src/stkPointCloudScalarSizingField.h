...
namespace stk {
    ...
    public:
        ...
        void SetSizingFieldArray(vtkDataArray* array)
        {
            this->SizingFieldArray = array;
        }

        vtkDataArray* GetSizingFieldArray()
        {
            return this->SizingFieldArray;
        }
        ...
        vtkPointSet* GetPointCloud()
        {
            return this->PointCloud;
        }

        void SetDefaultCellSize(double cellSize)
        {
