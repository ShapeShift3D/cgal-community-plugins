...
stkCGALBoolean2DMesher::stkCGALBoolean2DMesher()
{
  this->SetNumberOfInputPorts(2);
  this->SetNumberOfOutputPorts(1);
  this->OperationMode = stkCGALBoolean2DMesher::OperationModes::INTERSECT;
  this->Plane = stkCGALBoolean2DMesher::Planes::XY;
...
//---------------------------------------------------
vtkPolyData* stkCGALBoolean2DMesher::GetInputPolyLineSetA()
{
...
//----------------------------------------------------
vtkPolyData* stkCGALBoolean2DMesher::GetInputPolyLineSetB()
{
...
int stkCGALBoolean2DMesher::RequestData(vtkInformation *,
