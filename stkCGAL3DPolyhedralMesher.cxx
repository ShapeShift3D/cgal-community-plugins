...
// ----------------------------------------------------------------------------
stkCGAL3DPolyhedralMesher::stkCGAL3DPolyhedralMesher()
{
  ...
  // Constraint flags
  this->TopologicalStructure = stkCGAL3DPolyhedralMesher::TopologicalStructures::MANIFOLD;
...
//----------------------------------------------------------------------------
void stkCGAL3DPolyhedralMesher::PrintSelf(ostream& os, vtkIndent indent)
{
...
*/
vtkPolyData* stkCGAL3DPolyhedralMesher::GetInteriorSurfaces()
{
...
*  @return vtkPolyData*
*/
vtkPolyData* stkCGAL3DPolyhedralMesher::GetBoundingDomain()
{
...
*  @return vtkPointSet*
*/
vtkPointSet* stkCGAL3DPolyhedralMesher::GetSizingField()
{
