/**
* \class vtkCGALPolygonOrientOperator
*
* \brief 
*        
...
//---------VTK----------------------------------
#include "vtkCGALPolygonOrientOperator.h"
...
//----------
// Declare the plugin
vtkStandardNewMacro(vtkCGALPolygonOrientOperator);
...
vtkCGALPolygonOrientOperator::vtkCGALPolygonOrientOperator()
{
...
//---------------------------------------------------
vtkPolyData* vtkCGALPolygonOrientOperator::GetInputPolyLine()
{
...
int vtkCGALPolygonOrientOperator::RequestData(vtkInformation *,
                                ...
                                vtkInformationVector *outputVector)
{
	...
	if (this->ForcePolyLineOrientation)
	{
		...
		{
		case vtkCGALPolygonOrientOperator::PolygonOrientations::CLOCKWISE:
		{
			if (orient == CGAL::COUNTERCLOCKWISE) { polygon.reverse_orientation(); }
			break;
		}
		case vtkCGALPolygonOrientOperator::PolygonOrientations::COUNTERCLOCKWISE:
		{
