...
//----------------------------------------------------------------------------
int vtkCGALRegionGrowing::RequestData(vtkInformation* vtkNotUsed(request),
...
int vtkCGALRegionGrowing::Detection(vtkPolyData* input, vtkPolyData* output)
{
  ...
  alignNormalsFilter->SetFlipNormals(true);
  ...
  vtkDataArray* cellsNormalArray =
    alignNormalsFilter->GetOutput()->GetCellData()->GetArray("Normals");
