/**
* \class vtkCGALPolygonSetToPolyLineSet
*
* \brief 
*        
...
//----------
// Declare the plugin
vtkStandardNewMacro(vtkCGALPolygonSetToPolyLineSet);

// -----------------------------------------------------------------------------
// Constructor
// Fills the number of input and output objects.
// Initializes the members that need it.
vtkCGALPolygonSetToPolyLineSet::vtkCGALPolygonSetToPolyLineSet()
{
...
//---------------------------------------------------
vtkPolyData* vtkCGALPolygonSetToPolyLineSet::GetOutputPolyLineSet()
{
	return vtkPolyData::SafeDownCast(this->GetOutputDataObject(0));
}

//---------------------------------------------------
void vtkCGALPolygonSetToPolyLineSet::SetInputPolygonSet(Polygon_set_2& polygonSet)
{
...
int vtkCGALPolygonSetToPolyLineSet::RequestData(vtkInformation *,
                                ...
                                vtkInformationVector *outputVector)
{
	...
	if (this->DebugMode)
	{
		vtkCGALPolygonUtilities::PrintPolygonSet2Properties(this->PolygonSet, "Polygon Set", this->PrintPoints);
	}
