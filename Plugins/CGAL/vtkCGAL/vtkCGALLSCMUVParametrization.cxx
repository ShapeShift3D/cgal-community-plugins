/**
* \class vtkCGALLSCMUVParametrization
*
...
//---------VTK----------------------------------
#include "vtkCGALLSCMUVParametrization.h"
...
vtkStandardNewMacro(vtkCGALLSCMUVParametrization);

// -----------------------------------------------------------------------------
vtkCGALLSCMUVParametrization::vtkCGALLSCMUVParametrization()
{
	this->Lambda = 1000;
...
//---------------------------------------------------
int vtkCGALLSCMUVParametrization::RequestData(vtkInformation*,
...
bool vtkCGALLSCMUVParametrization::UpdatePointCoordinates(SurfaceMesh& sm, VertexUVMap& uv_map, vtkPolyData* polyData)
{
