...
#ifndef stkCGALIsotropicRemeshingFilter_h
#define stkCGALIsotropicRemeshingFilter_h

#include <stkCGALModule.h>
#include <vtkPolyDataAlgorithm.h>

class STKCGAL_EXPORT stkCGALIsotropicRemeshingFilter : public vtkPolyDataAlgorithm
{
public:
  static stkCGALIsotropicRemeshingFilter* New();
  vtkTypeMacro(stkCGALIsotropicRemeshingFilter, vtkPolyDataAlgorithm);
