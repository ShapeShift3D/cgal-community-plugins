...
//----------------------------------------------------------------------------
stkCGALEfficientRANSAC::stkCGALEfficientRANSAC()
{
...
//----------------------------------------------------------------------------
int stkCGALEfficientRANSAC::RequestData(
...
int stkCGALEfficientRANSAC::Detection(vtkPolyData *input, vtkPolyData *output)
{
  ...
  if (!stkCGALEfficientRANSAC::vtkPolyDataToOrientedPoints<CGalKernel, CGalOrientedPointVector>(input, points))
  {
