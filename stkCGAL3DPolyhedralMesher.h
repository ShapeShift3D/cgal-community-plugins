...
public:
  ...
  */
  ...
  {
      this->SetTopologicalStructure(stkCGAL3DPolyhedralMesher::TopologicalStructures::MANIFOLD);
  }

  virtual void SetTopologicalStructureToManifoldWithBoundary(void)
  {
      this->SetTopologicalStructure(stkCGAL3DPolyhedralMesher::TopologicalStructures::MANIFOLD_WITH_BOUNDARY);
  }

  virtual void SetTopologicalStructureToNonManifold(void)
  {
      this->SetTopologicalStructure(stkCGAL3DPolyhedralMesher::TopologicalStructures::NON_MANIFOLD);
  }
